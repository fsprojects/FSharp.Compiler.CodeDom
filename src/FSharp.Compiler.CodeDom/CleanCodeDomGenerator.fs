...
//
// This CodeDomGenerator is used to generate "clean" code for very simple cases in IDEs (e.g. monodevelop)
// for ASP.NET, 'empty class', snippets and other things.
//
...
module internal FSharp.Compiler.CodeDom.Internal.CleanGenerator
